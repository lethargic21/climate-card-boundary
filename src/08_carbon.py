...
출력 outputs/tables/carbon_range.csv, carbon_boundary.csv, carbon_seoul_check.csv
"""
...
def main() -> None:
    ...
    levels = {lv: {k: float(ef.at[k, lv]) for k in ("trip_km", "car_ef", "occupancy")} for lv in ("low", "central", "high")}
